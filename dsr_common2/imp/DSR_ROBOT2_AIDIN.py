...
########################################################################################################################################
class CDsrRobot:
    def __init__(self, robot_id='dsr01', robot_model='m1013', g_node=None):
        self._robot_id = robot_id
        self._robot_model = robot_model
        self._g_node = g_node
        print("CDsrRobot(): self._robot_id = %s, self._robot_model = %s" %(self._robot_id, self._robot_model))

        self._srv_name_prefix   = robot_id #'/' + self._robot_id + self._robot_model #ROS2
        ...
        # system Operations
        self._ros2_set_robot_mode             = self._g_node.create_client(SetRobotMode, self._srv_name_prefix +"/system/set_robot_mode") ; self.req_SetRobotMode = SetRobotMode.Request()
        self._ros2_get_robot_mode             = self._g_node.create_client(GetRobotMode, self._srv_name_prefix +"/system/get_robot_mode") ; self.req_GetRobotMode = GetRobotMode.Request()
        self._ros2_set_robot_system           = self._g_node.create_client(SetRobotSystem, self._srv_name_prefix +"/system/set_robot_system") ; self.req_SetRobotSystem = SetRobotSystem.Request()
        self._ros2_get_robot_system           = self._g_node.create_client(GetRobotSystem, self._srv_name_prefix +"/system/get_robot_system") ; self.req_GetRobotSystem = GetRobotSystem.Request()
        self._ros2_get_robot_state            = self._g_node.create_client(GetRobotState, self._srv_name_prefix +"/system/get_robot_state") ; self.req_GetRobotState = GetRobotState.Request()
        self._ros2_set_robot_speed_mode       = self._g_node.create_client(SetRobotSpeedMode, self._srv_name_prefix +"/system/set_robot_speed_mode") ; self.req_SetRobotSpeedMode = SetRobotSpeedMode.Request()
        self._ros2_get_robot_speed_mode       = self._g_node.create_client(GetRobotSpeedMode, self._srv_name_prefix +"/system/get_robot_speed_mode") ; self.req_GetRobotSpeedMode = GetRobotSpeedMode.Request()
        self._ros2_set_safe_stop_reset_type   = self._g_node.create_client(SetSafeStopResetType, self._srv_name_prefix +"/system/set_safe_stop_reset_type") ; self.req_SetSafeStopResetType = SetSafeStopResetType.Request()
        self._ros2_get_last_alarm             = self._g_node.create_client(GetLastAlarm, self._srv_name_prefix +"/system/get_last_alarm") ; self.req_GetLastAlarm = GetLastAlarm.Request()
        self._ros2_get_current_pose           = self._g_node.create_client(GetCurrentPose, self._srv_name_prefix +"/system/get_current_pose") ; self.req_GetCurrentPose = GetCurrentPose.Request()

    
        #  motion Operations
        self._ros2_movej                      = self._g_node.create_client(MoveJoint,              self._srv_name_prefix +"/motion/move_joint") ; self.req_MoveJoint = MoveJoint.Request()
        self._ros2_movel                      = self._g_node.create_client(MoveLine,               self._srv_name_prefix +"/motion/move_line") ; self.req_MoveLine = MoveLine.Request()
        self._ros2_movejx                     = self._g_node.create_client(MoveJointx,             self._srv_name_prefix +"/motion/move_jointx") ; self.req_MoveJointx = MoveJointx.Request()
        self._ros2_movec                      = self._g_node.create_client(MoveCircle,             self._srv_name_prefix +"/motion/move_circle") ; self.req_MoveCircle = MoveCircle.Request()
        self._ros2_movesj                     = self._g_node.create_client(MoveSplineJoint,        self._srv_name_prefix +"/motion/move_spline_joint") ; self.req_MoveSplineJoint = MoveSplineJoint.Request() 
        self._ros2_movesx                     = self._g_node.create_client(MoveSplineTask,         self._srv_name_prefix +"/motion/move_spline_task") ; self.req_MoveSplineTask = MoveSplineTask.Request()
        self._ros2_moveb                      = self._g_node.create_client(MoveBlending,           self._srv_name_prefix +"/motion/move_blending") ; self.req_MoveBlending = MoveBlending.Request()
        self._ros2_move_spiral                = self._g_node.create_client(MoveSpiral,             self._srv_name_prefix +"/motion/move_spiral") ; self.req_MoveSpiral = MoveSpiral.Request()
        self._ros2_move_periodic              = self._g_node.create_client(MovePeriodic,           self._srv_name_prefix +"/motion/move_periodic") ; self.req_MovePeriodic = MovePeriodic.Request()
        self._ros2_move_wait                  = self._g_node.create_client(MoveWait,               self._srv_name_prefix +"/motion/move_wait") ; self.req_MoveWait = MoveWait.Request()
        self._ros2_jog                        = self._g_node.create_client(Jog,                    self._srv_name_prefix +"/motion/jog") ; self.req_Jog = Jog.Request()
        self._ros2_jog_multi                  = self._g_node.create_client(JogMulti,               self._srv_name_prefix +"/motion/jog_multi") ; self.req_JogMulti = JogMulti.Request()
        self._ros2_trans                      = self._g_node.create_client(Trans,                  self._srv_name_prefix +"/motion/trans") ; self.req_Trans = Trans.Request()

        self._ros2_fkin                       = self._g_node.create_client(Fkin,                   self._srv_name_prefix +"/motion/fkin") ; self.req_Fkin = Fkin.Request()
        self._ros2_ikin                       = self._g_node.create_client(Ikin,                   self._srv_name_prefix +"/motion/ikin") ; self.req_Ikin = Ikin.Request()
        self._ros2_set_ref_coord              = self._g_node.create_client(SetRefCoord,            self._srv_name_prefix +"/motion/set_ref_coord") ; self.req_SetRefCoord = SetRefCoord.Request()
        self._ros2_move_home                  = self._g_node.create_client(MoveHome,               self._srv_name_prefix +"/motion/move_home") ; self.req_MoveHome = MoveHome.Request()
        self._ros2_check_motion               = self._g_node.create_client(CheckMotion,            self._srv_name_prefix +"/motion/check_motion") ; self.req_CheckMotion = CheckMotion.Request()
        self._ros2_change_operation_speed     = self._g_node.create_client(ChangeOperationSpeed,   self._srv_name_prefix +"/motion/change_operation_speed") ; self.req_ChangeOperationSpeed = ChangeOperationSpeed.Request()
        self._ros2_enable_alter_motion        = self._g_node.create_client(EnableAlterMotion,      self._srv_name_prefix +"/motion/enable_alter_motion") ; self.req_EnableAlterMotion = EnableAlterMotion.Request()
        self._ros2_alter_motion               = self._g_node.create_client(AlterMotion,            self._srv_name_prefix +"/motion/alter_motion") ; self.req_AlterMotion = AlterMotion.Request()
        self._ros2_disable_alter_motion       = self._g_node.create_client(DisableAlterMotion,     self._srv_name_prefix +"/motion/disable_alter_motion") ; self.req_DisableAlterMotion = DisableAlterMotion.Request()
        self._ros2_set_singularity_handling   = self._g_node.create_client(SetSingularityHandling, self._srv_name_prefix +"/motion/set_singularity_handling") ; self.req_SetSingularityHandling = SetSingularityHandling.Request()


        # Auxiliary Control Operations
        self._ros2_get_control_mode               = self._g_node.create_client(GetControlMode,     self._srv_name_prefix +"/aux_control/get_control_mode") ; self.req_GetControlMode = GetControlMode.Request()
        self._ros2_get_control_space              = self._g_node.create_client(GetControlSpace,    self._srv_name_prefix +"/aux_control/get_control_space") ; self.req_GetControlSpace = GetControlSpace.Request()
    
        self._ros2_get_current_posj               = self._g_node.create_client(GetCurrentPosj,     self._srv_name_prefix +"/aux_control/get_current_posj") ; self.req_GetCurrentPosj = GetCurrentPosj.Request()
        self._ros2_get_current_velj               = self._g_node.create_client(GetCurrentVelj,     self._srv_name_prefix +"/aux_control/get_current_velj") ; self.req_GetCurrentVelj = GetCurrentVelj.Request()
        self._ros2_get_desired_posj               = self._g_node.create_client(GetDesiredPosj,     self._srv_name_prefix +"/aux_control/get_desired_posj") ; self.req_GetDesiredPosj = GetDesiredPosj.Request()
        self._ros2_get_desired_velj               = self._g_node.create_client(GetDesiredVelj,     self._srv_name_prefix +"/aux_control/get_desired_velj") ; self.req_GetDesiredVelj = GetDesiredVelj.Request()
    
        self._ros2_get_current_posx               = self._g_node.create_client(GetCurrentPosx,     self._srv_name_prefix +"/aux_control/get_current_posx") ; self.req_GetCurrentPosx = GetCurrentPosx.Request()
        self._ros2_get_current_velx               = self._g_node.create_client(GetCurrentVelx,     self._srv_name_prefix +"/aux_control/get_current_velx") ; self.req_GetCurrentVelx = GetCurrentVelx.Request()
        self._ros2_get_desired_posx               = self._g_node.create_client(GetDesiredPosx,     self._srv_name_prefix +"/aux_control/get_desired_posx") ; self.req_GetDesiredPosx = GetDesiredPosx.Request()
        self._ros2_get_desired_velx               = self._g_node.create_client(GetDesiredVelx,     self._srv_name_prefix +"/aux_control/get_desired_velx") ; self.req_GetDesiredVelx = GetDesiredVelx.Request()
     
        self._ros2_get_current_tool_flange_posx   = self._g_node.create_client(GetCurrentToolFlangePosx,   self._srv_name_prefix +"/aux_control/get_current_tool_flange_posx") ; self.req_GetCurrentToolFlangePosx = GetCurrentToolFlangePosx.Request()
     
        self._ros2_get_current_solution_space     = self._g_node.create_client(GetCurrentSolutionSpace,    self._srv_name_prefix +"/aux_control/get_current_solution_space") ; self.req_GetCurrentSolutionSpace = GetCurrentSolutionSpace.Request()
        self._ros2_get_current_rotm               = self._g_node.create_client(GetCurrentRotm,             self._srv_name_prefix +"/aux_control/get_current_rotm") ; self.req_GetCurrentRotm = GetCurrentRotm.Request()
        self._ros2_get_joint_torque               = self._g_node.create_client(GetJointTorque,             self._srv_name_prefix +"/aux_control/get_joint_torque") ; self.req_GetJointTorque = GetJointTorque.Request()
        self._ros2_get_external_torque            = self._g_node.create_client(GetExternalTorque,          self._srv_name_prefix +"/aux_control/get_external_torque") ; self.req_GetExternalTorque = GetExternalTorque.Request()
        self._ros2_get_tool_force                 = self._g_node.create_client(GetToolForce,               self._srv_name_prefix +"/aux_control/get_tool_force") ; self.req_GetToolForce = GetToolForce.Request()
        self._ros2_get_solution_space             = self._g_node.create_client(GetSolutionSpace,           self._srv_name_prefix +"/aux_control/get_solution_space") ; self.req_GetSolutionSpace = GetSolutionSpace.Request()
        self._ros2_get_orientation_error          = self._g_node.create_client(GetOrientationError,        self._srv_name_prefix +"/aux_control/get_orientation_error") ; self.req_GetOrientationError = GetOrientationError.Request()

        # Force/Stiffness Control & others Operations
        self._ros2_get_workpiece_weight        = self._g_node.create_client(GetWorkpieceWeight,            self._srv_name_prefix +"/force/get_workpiece_weight") ; self.req_GetWorkpieceWeight = GetWorkpieceWeight.Request()
        self._ros2_reset_workpiece_weight      = self._g_node.create_client(ResetWorkpieceWeight,          self._srv_name_prefix +"/force/reset_workpiece_weight") ; self.req_ResetWorkpieceWeight = ResetWorkpieceWeight.Request()

        self._ros2_parallel_axis1              = self._g_node.create_client(ParallelAxis1,                 self._srv_name_prefix +"/force/parallel_axis1") ; self.req_ParallelAxis1 = ParallelAxis1.Request()
        self._ros2_parallel_axis2              = self._g_node.create_client(ParallelAxis2,                 self._srv_name_prefix +"/force/parallel_axis2") ; self.req_ParallelAxis2 = ParallelAxis2.Request()
        self._ros2_align_axis1                 = self._g_node.create_client(AlignAxis1,                    self._srv_name_prefix +"/force/align_axis1") ; self.req_AlignAxis1 = AlignAxis1.Request()
        self._ros2_align_axis2                 = self._g_node.create_client(AlignAxis2,                    self._srv_name_prefix +"/force/align_axis2") ; self.req_AlignAxis2 = AlignAxis2.Request()
        self._ros2_is_done_bolt_tightening     = self._g_node.create_client(IsDoneBoltTightening,          self._srv_name_prefix +"/force/is_done_bolt_tightening") ; self.req_IsDoneBoltTightening = IsDoneBoltTightening.Request()
        self._ros2_release_compliance_ctrl     = self._g_node.create_client(ReleaseComplianceCtrl,         self._srv_name_prefix +"/force/release_compliance_ctrl") ; self.req_ReleaseComplianceCtrl = ReleaseComplianceCtrl.Request()
        self._ros2_task_compliance_ctrl        = self._g_node.create_client(TaskComplianceCtrl,            self._srv_name_prefix +"/force/task_compliance_ctrl") ; self.req_TaskComplianceCtrl = TaskComplianceCtrl.Request()
        self._ros2_set_stiffnessx              = self._g_node.create_client(SetStiffnessx,                 self._srv_name_prefix +"/force/set_stiffnessx") ; self.req_SetStiffnessx = SetStiffnessx.Request()
        self._ros2_calc_coord                  = self._g_node.create_client(CalcCoord,                     self._srv_name_prefix +"/force/calc_coord") ; self.req_CalcCoord = CalcCoord.Request()
        self._ros2_set_user_cart_coord1        = self._g_node.create_client(SetUserCartCoord1,             self._srv_name_prefix +"/force/set_user_cart_coord1") ; self.req_SetUserCartCoord1 = SetUserCartCoord1.Request()
        self._ros2_set_user_cart_coord2        = self._g_node.create_client(SetUserCartCoord2,             self._srv_name_prefix +"/force/set_user_cart_coord2") ; self.req_SetUserCartCoord2 = SetUserCartCoord2.Request()
        self._ros2_set_user_cart_coord3        = self._g_node.create_client(SetUserCartCoord3,             self._srv_name_prefix +"/force/set_user_cart_coord3") ; self.req_SetUserCartCoord3 = SetUserCartCoord3.Request()
        self._ros2_overwrite_user_cart_coord   = self._g_node.create_client(OverwriteUserCartCoord,        self._srv_name_prefix +"/force/overwrite_user_cart_coord") ; self.req_OverwriteUserCartCoord = OverwriteUserCartCoord.Request()
        self._ros2_get_user_cart_coord         = self._g_node.create_client(GetUserCartCoord,              self._srv_name_prefix +"/force/get_user_cart_coord") ; self.req_GetUserCartCoord = GetUserCartCoord.Request()
        self._ros2_set_desired_force           = self._g_node.create_client(SetDesiredForce,               self._srv_name_prefix +"/force/set_desired_force") ; self.req_SetDesiredForce = SetDesiredForce.Request()
        self._ros2_release_force               = self._g_node.create_client(ReleaseForce,                  self._srv_name_prefix +"/force/release_force") ; self.req_ReleaseForce = ReleaseForce.Request()
        self._ros2_check_position_condition    = self._g_node.create_client(CheckPositionCondition,        self._srv_name_prefix +"/force/check_position_condition") ; self.req_CheckPositionCondition = CheckPositionCondition.Request()
        self._ros2_check_force_condition       = self._g_node.create_client(CheckForceCondition,           self._srv_name_prefix +"/force/check_force_condition") ; self.req_CheckForceCondition = CheckForceCondition.Request()
        self._ros2_check_orientation_condition1= self._g_node.create_client(CheckOrientationCondition1,    self._srv_name_prefix +"/force/check_orientation_condition1") ; self.req_CheckOrientationCondition1 = CheckOrientationCondition1.Request()
        self._ros2_check_orientation_condition2= self._g_node.create_client(CheckOrientationCondition2,    self._srv_name_prefix +"/force/check_orientation_condition2") ; self.req_CheckOrientationCondition2 = CheckOrientationCondition2.Request()
        self._ros2_coord_transform             = self._g_node.create_client(CoordTransform,                self._srv_name_prefix +"/force/coord_transform") ; self.req_CoordTransform = CoordTransform.Request()

        #  GPIO Operations
        self._ros2_set_digital_output         = self._g_node.create_client(SetCtrlBoxDigitalOutput,        self._srv_name_prefix +"io/set_ctrl_box_digital_output") ; self.req_SetCtrlBoxDigitalOutput = SetCtrlBoxDigitalOutput.Request()
        self._ros2_get_digital_input          = self._g_node.create_client(GetCtrlBoxDigitalInput,         self._srv_name_prefix +"io/get_ctrl_box_digital_input") ; self.req_GetCtrlBoxDigitalInput = GetCtrlBoxDigitalInput.Request()
        self._ros2_set_tool_digital_output    = self._g_node.create_client(SetToolDigitalOutput,           self._srv_name_prefix +"io/set_tool_digital_output") ; self.req_SetToolDigitalOutput= SetToolDigitalOutput.Request()
        self._ros2_get_tool_digital_input     = self._g_node.create_client(GetToolDigitalInput,            self._srv_name_prefix +"io/get_tool_digital_input") ; self.req_GetToolDigitalInput = GetToolDigitalInput.Request()
        self._ros2_set_analog_output          = self._g_node.create_client(SetCtrlBoxAnalogOutput,         self._srv_name_prefix +"io/set_ctrl_box_analog_output") ; self.req_SetCtrlBoxAnalogOutput = SetCtrlBoxAnalogOutput.Request()
        self._ros2_get_analog_input           = self._g_node.create_client(GetCtrlBoxAnalogInput,          self._srv_name_prefix +"io/get_ctrl_box_analog_input") ; self.req_GetCtrlBoxAnalogInput = GetCtrlBoxAnalogInput.Request()
        self._ros2_set_mode_analog_output     = self._g_node.create_client(SetCtrlBoxAnalogOutputType,     self._srv_name_prefix +"io/set_ctrl_box_analog_output_type") ; self.req_SetCtrlBoxAnalogOutputType = SetCtrlBoxAnalogOutputType.Request()  
        self._ros2_set_mode_analog_input      = self._g_node.create_client(SetCtrlBoxAnalogInputType,      self._srv_name_prefix +"io/set_ctrl_box_analog_input_type") ; self.req_SetCtrlBoxAnalogInputType = SetCtrlBoxAnalogInputType.Request()   
        self._ros2_get_digital_output         = self._g_node.create_client(GetCtrlBoxDigitalOutput,        self._srv_name_prefix +"io/get_ctrl_box_digital_output") ; self.req_GetCtrlBoxDigitalOutput = GetCtrlBoxDigitalOutput.Request()
        self._ros2_get_tool_digital_output    = self._g_node.create_client(GetToolDigitalOutput,           self._srv_name_prefix +"io/get_tool_digital_output") ; self.req_GetToolDigitalOutput = GetToolDigitalOutput.Request()

        #  Modbus Operations, 
        self._ros2_set_modbus_output          = self._g_node.create_client(SetModbusOutput,                self._srv_name_prefix +"/modbus/set_modbus_output") ; self.req_SetModbusOutput = SetModbusOutput.Request()
        self._ros2_get_modbus_input           = self._g_node.create_client(GetModbusInput,                 self._srv_name_prefix +"/modbus/get_modbus_input") ; self.req_GetModbusInput = GetModbusInput.Request()
        self._ros2_add_modbus_signal          = self._g_node.create_client(ConfigCreateModbus,             self._srv_name_prefix +"/modbus/config_create_modbus") ; self.req_ConfigCreateModbus = ConfigCreateModbus.Request()
        self._ros2_del_modbus_signal          = self._g_node.create_client(ConfigDeleteModbus,             self._srv_name_prefix +"/modbus/config_delete_modbus") ; self.req_ConfigDeleteModbus = ConfigDeleteModbus.Request()

        # TCP Operations, 
        self._ros2_set_current_tcp            = self._g_node.create_client(SetCurrentTcp,                  self._srv_name_prefix +"/tcp/set_current_tcp") ; self.req_SetCurrentTcp = SetCurrentTcp.Request()
        self._ros2_get_current_tcp            = self._g_node.create_client(GetCurrentTcp,                  self._srv_name_prefix +"/tcp/get_current_tcp") ; self.req_GetCurrentTcp = GetCurrentTcp.Request()
        self._ros2_config_create_tcp          = self._g_node.create_client(ConfigCreateTcp,                self._srv_name_prefix +"/tcp/config_create_tcp") ; self.req_ConfigCreateTcp = ConfigCreateTcp.Request()
        self._ros2_config_delete_tcp          = self._g_node.create_client(ConfigDeleteTcp,                self._srv_name_prefix +"/tcp/config_delete_tcp") ; self.req_ConfigDeleteTcp = ConfigDeleteTcp.Request()
 
        # Tool Operations, 
        self._ros2_set_current_tool           = self._g_node.create_client(SetCurrentTool,                 self._srv_name_prefix +"/tool/set_current_tool") ; self.req_SetCurrentTool = SetCurrentTool.Request()
        self._ros2_get_current_tool           = self._g_node.create_client(GetCurrentTool,                 self._srv_name_prefix +"/tool/get_current_tool") ; self.req_GetCurrentTool = GetCurrentTool.Request()
        self._ros2_config_create_tool         = self._g_node.create_client(ConfigCreateTool,               self._srv_name_prefix +"/tool/config_create_tool") ; self.req_ConfigCreateTool = ConfigCreateTool.Request()
        self._ros2_config_delete_tool         = self._g_node.create_client(ConfigDeleteTool,               self._srv_name_prefix +"/tool/config_delete_tool") ; self.req_ConfigDeleteTool = ConfigDeleteTool.Request()
        self._ros2_set_tool_shape             = self._g_node.create_client(SetToolShape,                   self._srv_name_prefix +"/tool/set_tool_shape") ; self.req_SetToolShape = SetToolShape.Request()

        # DRL Operations, 
        self._ros2_drl_pause                  = self._g_node.create_client(DrlPause,                       self._srv_name_prefix +"/drl/drl_pause") ; self.req_DrlPause = DrlPause.Request()
        self._ros2_drl_resume                 = self._g_node.create_client(DrlResume,                      self._srv_name_prefix +"/drl/drl_resume") ; self.req_DrlResume = DrlResume.Request()
        self._ros2_drl_start                  = self._g_node.create_client(DrlStart,                       self._srv_name_prefix +"/drl/drl_start") ; self.req_DrlStart = DrlStart.Request()
        self._ros2_drl_stop                   = self._g_node.create_client(DrlStop,                        self._srv_name_prefix +"/drl/drl_stop") ; self.req_DrlStop = DrlStop.Request()
        self._ros2_get_drl_state              = self._g_node.create_client(GetDrlState,                    self._srv_name_prefix +"/drl/get_drl_state") ; self.req_GetDrlState = GetDrlState.Request()
    ...
    def set_velj(self, vel):
        ...
        # set global velj
        self._g_velj = vel_list

        print_result("0 = set_velj(vel:{0})".format(dr_form(vel)))
        return 0

    def set_accj(self, acc):
        acc_list = None
        ...
        # set global velj
        self._g_accj = acc_list

        print_result("0 = set_accj(acc:{0})".format(dr_form(acc)))
        return 0

    def set_velx(self, vel1, vel2=DR_COND_NONE):
        #print("vel1={0}, vel2={1}".format(vel1, vel2))
        ...
        # set global velx
        self._g_velx = [vel1, vel2]

        print_result("0 = set_velx(vel1:{0}, vel2:{1})".format(dr_form(vel1), dr_form(vel2)))
        return 0

    def set_accx(self, acc1, acc2=DR_COND_NONE):
        #print("acc1={0}, acc2={1}".format(acc1, acc2))
    ...
    def set_robot_mode(self, robot_mode):
        ...
        if __ROS2__:
            ...
            rclpy.spin_until_future_complete(self._g_node, future)

            try:
                result = future.result()
            except Exception as e:
                self._g_node.get_logger().info('set_robot_mode Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_robot_mode(self):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_robot_mode Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def set_robot_system(self, robot_system):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('set_robot_system Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1   
                    self._g_node.get_logger().info('set_robot_system Service call failed')
                else:        
                    ret = 0 if (result.success == True) else -1                
        return ret
    ...
    def get_robot_system(self):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_robot_system Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_robot_state(self):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_robot_state Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def set_robot_speed_mode(self, speed_mode):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('set_robot_speed_mode Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_robot_speed_mode(self):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_robot_speed_mode Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def set_safe_stop_reset_type(self, reset_type):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('set_safe_stop_reset_type Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_current_pose(self, space_type):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_current_pose Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_current_solution_space(self):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_current_solution_space Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_last_alarm(self):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_last_alarm Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_control_mode(self):
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_control_mode Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_control_space(self):
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_control_space Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_current_posj(self):
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_current_posj Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:     
    ...
    def get_current_velj(self):
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_current_velj Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_desired_posj(self):
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_desired_posj Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_desired_velj(self):
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_desired_velj Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_current_posx(self, ref=None):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_current_posx Service call failed %r' % (e,))
            else:
                if result == None:
                    return None, None    
                else:        
    ...
    def get_current_tool_flange_posx(self, ref=None):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_current_tool_flange_posx Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_current_velx(self, ref=None):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_current_velx Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_desired_posx(self, ref=None):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_desired_posx Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_desired_velx(self, ref=None):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_desired_velx Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_current_rotm(self, ref=None):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_current_rotm Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_joint_torque(self):
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_joint_torque Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_external_torque(self):
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_external_torque Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_tool_force(self, ref=None):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_tool_force Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_solution_space(self, pos):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_solution_space Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_orientation_error(self, xd, xc, axis):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_orientation_error Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
...
##### MOTION ##############################################################################################################################
    ...
    def trans(self, pos, delta, ref=None, ref_out=DR_BASE):
        ...
        if __ROS2__: 
            ...
            try:
                ...
                self._g_node.get_logger().info('trans Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def fkin(self, pos, ref=None):
        ...
        if __ROS2__: 
            ...
            try:
                ...
                self._g_node.get_logger().info('fkin Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def ikin(self, pos, sol_space, ref=None):
        ...
        if __ROS2__: 
            ...
            try:
                ...
                self._g_node.get_logger().info('ikin Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def set_ref_coord(self, coord):
        ...
        if __ROS2__: 
            ...
            try:
                ...
                self._g_node.get_logger().info('set_ref_coord Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def _movej(self, pos, vel=None, acc=None, time=None, radius=None, mod= DR_MV_MOD_ABS, ra=DR_MV_RA_DUPLICATE, v=None, a=None, t=None, r=None, _async=0):
        ...
        if __ROS2__: 
            ...
            try:
                ...
                self._g_node.get_logger().info('movej Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def _movejx(self, pos, vel=None, acc=None, time=None, radius=None, ref=None, mod= DR_MV_MOD_ABS, ra=DR_MV_RA_DUPLICATE, sol=0, v=None, a=None, t=None, r=None, _async=0):
        ...
        if __ROS2__: 
            ...
            try:
                ...
                self._g_node.get_logger().info('movejx Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def _movel(self, pos, vel=None, acc=None, time=None, radius=None, ref=None, mod=DR_MV_MOD_ABS, ra=DR_MV_RA_DUPLICATE, v=None, a=None, t=None, r=None, _async=0):
        ...
        if __ROS2__: 
            ...
            try:
                ...
                self._g_node.get_logger().info('movel Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def _movec(self, pos1, pos2, vel=None, acc=None, time=None, radius=None, ref=None, mod= DR_MV_MOD_ABS, angle=None, ra=DR_MV_RA_DUPLICATE, v=None, a=None, t=None, r=None, an=None, _async=0):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('movec Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def _movesj(self, pos_list, vel=None, acc=None, time=None, mod= DR_MV_MOD_ABS, v=None, a=None, t=None, _async=0):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('movesj Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def _movesx(self, pos_list, vel=None, acc=None, time=None, ref=None, mod= DR_MV_MOD_ABS, vel_opt=DR_MVS_VEL_NONE, v=None, a=None, t=None, _async=0):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('movesx Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def _moveb(self, seg_list, vel=None, acc=None, ref=None, time=None, mod=DR_MV_MOD_ABS, v=None, a=None, t=None, _async=0):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('moveb Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def _move_spiral(self, rev=10, rmax=10, lmax=0, vel=None, acc=None, time=None, axis=DR_AXIS_Z, ref=DR_TOOL, v=None, a=None, t=None, _async=0):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('move_spiral Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def _move_periodic(self, amp, period, atime=None, repeat=None, ref=DR_TOOL, _async=0):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('move_periodic Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def move_home(self, target=None):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('move_home Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def _move_wait(self, time):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('mwait Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def check_motion(self):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('check_motion Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def change_operation_speed(self, speed):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('change_operation_speed Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def enable_alter_motion(self, n, mode, ref=None, limit_dPOS=None, limit_dPOS_per=None):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('enable_alter_motion Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def alter_motion(self, dposx):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('alter_motion Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def disable_alter_motion(self):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('disable_alter_motion Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def set_singular_handling(self, mode = DR_AVOID):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('set_singular_handling Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def set_singularity_handling(self, mode = DR_AVOID):
        ret = self.set_singular_handling(mode)
        return ret
    ...
    def jog(self, jog_axis, ref=0, speed=0):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('jog Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def jog_multi(self, jog_axis_list, ref=0, speed=0):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('jog_multi Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_workpiece_weight(self):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_workpiece_weight Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def reset_workpiece_weight(self):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('reset_workpiece_weight Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
        ...
        if _nType == 2: # with ref
            ...
            if __ROS2__:
                ...
                try:
                    ...
                    self._g_node.get_logger().info('parallel_axis Service call failed %r' % (e,))
                else:
                    if result == None:
                        ret = -1    
                    else:        
        ...
        if _nType == 2: # with ref
            ...
            if __ROS2__:
                ...
                try:
                    ...
                    self._g_node.get_logger().info('align_axis Service call failed %r' % (e,))
                else:
                    if result == None:
                        ret = -1    
                    else:        
    ...
    def is_done_bolt_tightening(self, m=0, timeout=0, axis=None):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('is_done_bolt_tightening Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def release_compliance_ctrl(self):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('release_compliance_ctrl Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def task_compliance_ctrl(self, stx=[3000, 3000, 3000, 200, 200, 200], time=0):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('task_compliance_ctrl Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def set_stiffnessx(self, stx=[500, 500, 500, 100, 100, 100], time=0):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('set_stiffnessx Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def calc_coord(self, *args, **kargs):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('calc_coord Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
        ...
        if _nType == 0:
            ...
            if __ROS2__:
                ...
                try:
                    ...
                    self._g_node.get_logger().info('set_user_cart_coord Service call failed %r' % (e,))
                else:
                    if result == None:
                        ret = -1    
                    else:        
    ...
    def overwrite_user_cart_coord(self, id, pos, ref=None, gol=None):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('overwrite_user_cart_coord Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_user_cart_coord(self, id):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_user_cart_coord Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1, -1    
                else:        
    ...
    def set_desired_force(self, fd=[0, 0, 0, 0, 0, 0], dir=[0, 0, 0, 0, 0, 0], time=0, mod=DR_FC_MOD_ABS):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('set_desired_force Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def release_force(self, time=0):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('release_force Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def check_position_condition(self, axis, min=DR_COND_NONE, max=DR_COND_NONE, ref=None, mod= DR_MV_MOD_ABS, pos=None):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('check_position_condition Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def check_force_condition(self, axis, min=DR_COND_NONE, max=DR_COND_NONE, ref=None):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('check_force_condition Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
        ...
        if _cmd_type == 0:
            if __ROS2__:
                ...
                try:
                    ...
                    self._g_node.get_logger().info('check_orientation_condition Service call failed %r' % (e,))
                else:
                    if result == None:
                        ret = -1    
                    else:        
    ...
    def coord_transform(self, pose_in, ref_in=DR_BASE, ref_out=None):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('coord_transform Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_digital_input(self, index):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_digital_input Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_analog_input(self, ch):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_analog_input Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_tool_digital_input(self, index):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_tool_digital_input Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def set_digital_output(self, index, val=None):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('set_digital_output Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_digital_output(self, index):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_digital_output Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def set_analog_output(self, ch, val):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('set_analog_output Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def set_mode_analog_output(self, ch, mod):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('set_mode_analog_output Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def set_mode_analog_input(self, ch, mod):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('set_mode_analog_input Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def set_tool_digital_output(self, index, val=None):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('set_tool_digital_output Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_tool_digital_output(self, index):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_tool_digital_output Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def add_modbus_signal(self, ip, port, name, reg_type, index, value=0, slaveid=255):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('add_modbus_signal Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def del_modbus_signal(self, name):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('del_modbus_signal Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def set_modbus_output(self, iobus, val):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('set_modbus_output Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_modbus_input(self, iobus):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_modbus_input Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def set_tcp(self, name):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('set_tcp Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_tcp(self):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_tcp Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def set_tool(self, name):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('set_tool Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_tool(self):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_tool Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def set_tool_shape(self, name):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('set_tool_shape Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def add_tcp(self, name, pos):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('add_tcp Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def del_tcp(self, name):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('del_tcp Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def add_tool(self, name, weight, cog, inertia):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('add_tool Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def del_tool(self, name):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('del_tool Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def drl_script_run(self, robotSystem, code):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('drl_script_run Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def drl_script_stop(self, stop_mode):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('drl_script_stop Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def drl_script_pause(self):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('drl_script_pause Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def drl_script_resume(self):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('drl_script_resume Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
    ...
    def get_drl_state(self):
        ...
        if __ROS2__:
            ...
            try:
                ...
                self._g_node.get_logger().info('get_drl_state Service call failed %r' % (e,))
            else:
                if result == None:
                    ret = -1    
                else:        
